-- ============================================================================
-- SCRIPT DE MIGRACIÓN COMPLETO - CATÁLOGO MAXIPET
-- ============================================================================
...
CREATE TABLE public.productos (
    ...
    constraint productos_tamaño_check check (tamaño is null or tamaño in ('Pequeño', 'Mediano', 'Adulto'))
);
...
-- Índices para kilos y tamaño
CREATE INDEX productos_kilos_idx ON public.productos (kilos) WHERE kilos IS NOT NULL;
CREATE INDEX productos_tamaño_idx ON public.productos (tamaño) WHERE tamaño IS NOT NULL;
